...
data_model_name = "INNO-3-Kurs-4A"
...
rating_df = DataFrame(
    ...
    "Test: Quiz 1 (Punkte)": f'"{rating_table_name}"."Test: Quiz 1 (Punkte)"',
    "Test: Quiz 2 (Punkte)": f'"{rating_table_name}"."Test: Quiz 2 (Punkte)"',
    "Test: Quiz 3 (Punkte)": f'"{rating_table_name}"."Test: Quiz 3 (Punkte)"',
    "Test: Quiz 4 (Punkte)": f'"{rating_table_name}"."Test: Quiz 4 (Punkte)"',
    "Test: Quiz 5 (Punkte)": f'"{rating_table_name}"."Test: Quiz 5 (Punkte)"',
    "Test: Quiz 6 (Punkte)": f'"{rating_table_name}"."Test: Quiz 6 (Punkte)"',
    "Test: Quiz 7 (Punkte)": f'"{rating_table_name}"."Test: Quiz 7 (Punkte)"',
    "Quiz gesamt (Punkte)": f'"{rating_table_name}"."Quiz gesamt (Punkte)"',
    "Test: Exam Attempt 1 (Punkte)": f'"{rating_table_name}"."Test: Exam Attempt 1 (Punkte)"',
...
# use Quiz 1-7 to train the model
columns = [string for string in rating_df.columns if "Quiz" in string and "gesamt" not in string]

# convert the values to float
x = rating_df[columns].astype(float)
y_exam_points = rating_df["Test: Exam Attempt 1 (Punkte)"].astype(float)
...
result_df.drop(columns=["Test: Exam Attempt 1 (Punkte)", "Kurs gesamt (Punkte)"])
